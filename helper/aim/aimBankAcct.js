...
const AimBankAcct = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/aimBankAcct/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/aimBankAcct/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
	...
	getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/aimBankAcct/getRecord";
            const filterUrl = AimBankAcct.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(AimBankAcct.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/aimBankAcct/getPageDet";
            const filterUrl = AimBankAcct.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(AimBankAcct.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/aimBankAcct/getFilteredData";
            const filterUrl = AimBankAcct.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(AimBankAcct.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
...
if (filter.account_nr !== undefined) {
    url += "account_nr=" + filter.account_nr + "&";
}
if (filter.opening_bal !== undefined) {
    url += "opening_bal=" + filter.opening_bal + "&";
}
