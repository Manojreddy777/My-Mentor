...
const CommScheduler = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/commScheduler/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/commScheduler/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
    ...
    getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/commScheduler/getRecord";
    ...
    formatRecord: (data) => {
        ...
        for (let d of data) {
            formatted.push({
                ...
                sch_week: d.sch_week,
                process_status_id: d.process_status_id,             
    ...
    getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/commScheduler/getPageDet";
            const filterUrl = CommScheduler.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/commScheduler/getFilteredData";
            const filterUrl = CommScheduler.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
    ...
    getFilterUrl: (filter) => {
        ...
        if (filter !== undefined) {
            ...
            if (filter.process_status_id !== undefined) {
                url += "process_status_id=" + filter.process_status_id + "&";
            }
