...
import Component from "../../components/tnntAdmin/taLogDet";
import LogDetHelper from "../../helper/tnntAdmin/taLogDet";
// import alias_name from "../../helper/helper_source_name";
import TimelineComponent from "../../components/tnntAdmin/taLogDetAudit";
...
// }
  ...
  getPageDet(filter) {
    ...
    LogDetHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    LogDetHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"taLogDet_" + moment().format("DDMMYYhhmmss")}
