...
import Component from "../../components/pfmMgmt/pfCalendarEvents";
import CalendarEventsHelper from "../../helper/pfmMgmt/pfCalendarEvents";
...
export default class PfCalendarEvents extends React.Component {
  ...
  getPageDet(filter) {
    ...
    CalendarEventsHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    CalendarEventsHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
            ...
            // table_header1
                ...
                end_time:"End Time",
                base_com_id:"Base Component Name",
                base_com_rec_id:"Base Component Record",
...
{/* // table_header */}
                ...
                <th>Start Time</th>
                <th>End Time</th>
                <th>Base Component Name</th>
                <th>Base Component Record</th>
                <th>Record Status </th>
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"pfCalendarEvents_" + moment().format("DDMMYYhhmmss")}
