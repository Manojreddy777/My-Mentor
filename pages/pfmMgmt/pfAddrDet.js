...
import Component from "../../components/pfmMgmt/pfAddrDet";
import AddrDetHelper from "../../helper/pfmMgmt/pfAddrDet";
...
export default class pfAddrDet extends React.Component {
  ...
  getPageDet(filter) {
    ...
    AddrDetHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    AddrDetHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"pfAddrDet_" + moment().format("DDMMYYhhmmss")}
