...
import EmailModal from "../../components/pfmMgmt/pfNotifEmail";
...
export default class EmailNotification extends React.Component {
  ...
  async getData() {
    const { arr_com_claim, id_selectedStatus, username, tnnt_id } = this.state;
  ...
  getPageDet(filter) {
    ...
    PfNotifEmailHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    PfNotifEmailHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
                  ...
                  arr_parentTable
                    ...
                    .map((t) => (
                      ...
                      >
                        ...
                        <td>{t.status_id}</td>
                        <td>{t.sent_timestamp}</td>
                        <td>{t.delivery_recipt}</td>
                        <td>{t.read_receipt}</td>
                        <td>
