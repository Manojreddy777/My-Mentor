...
import WhattsAppNotifiModal from "../../components/pfmMgmt/pfNotifWapp";
...
export default class WhattsAppNotification extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      arr_employment_type: [],
      id_selected_employment: undefined,
      arr_status: [
        {
          id: 1,
          title: "Active",
  ...
  getForDropDown() {
    ...
    ddLookupHelper
      ...
      .then((data) => {
        this.setState({ arr_employment_type: data });
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  async getData() {
    ...
    try {
      ...
      const filter = {
        emp_type_id: id_selected_employment,
  ...
  render() {
    ...
    return (
      <div>
        ...
        <SideMenu tag="pfWhattsApp">
          <Head title="WhattsApp Notification" />
              ...
              <div className={styles.rowAlignment}>
                ...
                {/* <div className={styles.inputAlignment}>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      this.setState({
                        id_selected_employment: e.target.value,
                      })
                    }
                  >
                    <option value={0} disabled selected>
                  ...
                  arr_parentTable
                    ...
                    .map((t) => (
                      ...
                      >
                        ...
                        <td>{t.status_id}</td>
                        <td>{t.sent_timestamp == null ? "" : moment(t.sent_timestamp).format("DD-MM-YYYY HH:MM:SS")}</td>
                        <td>{t.delivery_receipt == null ? "" : moment(t.delivery_receipt).format("DD-MM-YYYY HH:MM:SS")}</td>
                        <td>{t.read_receipt == null ? "" : moment(t.read_receipt).format("DD-MM-YYYY HH:MM:SS")}</td>
                        <td>
                                  ...
                                  <ul>
                                    ...
                                    <li>
                                      <div
                                        onClick={() =>
                                          window.open(
                                            `/hrMgmt/hrManPowerAduit?rec_id=${t.id}`,
                                            "_blank",
                                            "noopener,noreferrer"
                                          )
                                        }
