...
import Component from "../../components/pfmMgmt/pfSource";
import SourcetHelper from "../../helper/pfmMgmt/pfSource";

export default class PfSource extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getPageDet(filter) {
    ...
    SourcetHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    SourcetHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
            ...
            // table_header1
                ...
                source_type_id:"Planned Start Date",
                version_id:"Planned End Date",
                src_code:"Total Number of Stalls",
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"pfSource_" + moment().format("DDMMYYhhmmss")}
