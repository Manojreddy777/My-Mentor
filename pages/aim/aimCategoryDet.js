...
import Component from "../../components/aim/aimCategoryDet";
import CategoryHelper from "../../helper/aim/aimCategoryDet";

export default class AimCategoryDet extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getPageDet(filter) {
    ...
    CategoryHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    CategoryHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
            ...
            // table_header1
                id:"ID",
                user_name:"User Name",
                category_grp_id:"Category Group ID",
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"aimCategoryDet_" + moment().format("DDMMYYhhmmss")}
