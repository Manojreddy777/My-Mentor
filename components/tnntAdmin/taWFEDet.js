...
import SampleHelper from "../../helper/tnntAdmin/taWFEDet";

export default class TaWFEDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
