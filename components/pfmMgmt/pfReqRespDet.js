...
import SampleHelper from "../../helper/pfmMgmt/pfReqRespDet";

export default class PfReqRespDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_req_det: data[0].req_det,
          text_res_det: data[0].res_det,
          text_event_timestamp: data[0].event_timestamp,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        req_det: text_req_det,
        res_det: text_res_det,
        event_timestamp: text_event_timestamp,
        device: text_device,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_event_timestamp}
                                    onChange={(e) =>
                                    this.setState({
                                        text_event_timestamp: e.target.value,
                                    })
                                    }
                                />
                                </div>
