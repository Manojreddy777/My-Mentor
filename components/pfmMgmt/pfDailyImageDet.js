...
import SampleHelper from "../../helper/pfmMgmt/pfDailyImageDet";

export default class PfDailyImageDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          date_display_date: data[0].display_date,
          text_image_url: data[0].image_url,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        display_date: date_display_date,
                            ...
                            *
                                    ...
                                    <div className={styles.inputCustom}>
                                        <DatePicker
                                            ...
                                            selected={date_display_date}
                                            onChange={(e) =>
                                                this.setState({ date_display_date: e })
                                            }
                                        />
                                    </div>
                                </div>    
