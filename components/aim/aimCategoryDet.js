...
import SampleHelper from "../../helper/aim/aimCategoryDet";
...
export default class AimCategoryDet extends React.Component {
  ...
  getCategory() {
    ...
    CategoryDropdown.getCategoryGrp(filter)
        .then((data) => {
            this.setState({ arr_getCategory: data });
        })
        .catch((err) => {
            console.log(err);
        });
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          int_category_grp_id: data[0].category_grp_id,
          text_catgory_grp_name: data[0].category_grp_name,
          text_category_name: data[0].category_name,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        category_grp_id: int_category_grp_id,
        category_name: text_category_name,
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div>
            <p className={styles.title}>
              {editable == undefined ? "Create Category" : editable ? "Update Category" : "View Category"}
            </p>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                              <select
                        value={
                          int_category_grp_id === undefined ? 0 : int_category_grp_id
                        }
                        onChange={(e) =>
                          this.setState({
                            int_category_grp_id: e.target.value,
                          })
                        }
                      >
                        ...
                        {arr_getCategory.map((s) => (
                          <option value={s.id}>{s.name}</option>
                        ))}
                      </select>
                    ) : (
                      <div className={styles.viewField}>
                        <p>{text_catgory_grp_name}</p>
                      </div>
                    )}
                            </div>
                        </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_category_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_category_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
