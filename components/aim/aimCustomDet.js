...
import SampleHelper from "../../helper/aim/aimCustomDet";

export default class AimCustomDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_ai_mentor_name: data[0].ai_mentor_name,
          text_ai_refer_me_as: data[0].ai_refer_me_as,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        ai_mentor_name: text_ai_mentor_name,
        ai_refer_me_as: text_ai_refer_me_as,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_ai_mentor_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_ai_mentor_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_ai_refer_me_as}
                                    onChange={(e) =>
                                    this.setState({
                                        text_ai_refer_me_as: e.target.value,
                                    })
                                    }
                                />
                                </div>
